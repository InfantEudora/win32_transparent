...
//    <- Result: Success
//
extern bool SaveBMPFile(const char *filename, HBITMAP bitmap, HDC bitmapDC, int width, int height){
    bool Success=false;
...
//hDC 0 = Desktop
HBITMAP GetScreenBMP(int x, int y, int width, int height, HDC hdc) {
