...
void ApplicationTank::Init(void){
    ...
    gltfloader.LoadGLTFFile("meshes/tank.glb");
...
void ApplicationTank::TestHeightmapRoundTrip(){
    ...
    const char* filename = "heightmap_roundtrip_test.png";
...
void ApplicationTank::TestHeightmapMesh(){
    ...
    int w = 0, h = 0;
    Texture tex;
    if (!LoadHeightmapPNG("textures/export_terrain_photoshop.png",heights,w,h,-1.0f,1.0f,&tex)){
