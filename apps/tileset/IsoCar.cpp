...
void IsoCar::HonkHorn(){
    if (soundsystem){
        //Was Rewind then Play, because one name meant one source and it had to be wound back
        //first. A voice from the pool starts at the beginning, and two horns can now sound
        //at once instead of one cutting the other off.
