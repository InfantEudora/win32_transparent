...
void ApplicationSim::Init(void){
    ...
    assetmanager->AddNewAssetFromOBJFile("sphere","meshes/sphere.obj");
    assetmanager->AddNewAssetFromOBJFile("sunhighlight","meshes/sunhighlight.obj");
    assetmanager->AddNewAssetFromOBJFile("ship","meshes/ship.obj");
    assetmanager->AddNewAssetFromOBJFile("plane","meshes/plane.obj");
