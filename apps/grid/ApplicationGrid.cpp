...
Scene* ApplicationGrid::CreateHandTestScene(){
    ...
    gltfloader.LoadGLTFFile("meshes/hand.glb");
    ...
    if (skeleton){
        ...
        //gltfloader.LoadGLTFFile("meshes/animations.glb");
...
Scene* ApplicationGrid::CreateTestScene(){
    ...
    temp->SetMesh(OBJLoader::ParseOBJFile("meshes/tile_001.obj",&loaded_materials));
    assetmanager->AddNewAsset("tile_001",temp);
    temp->SetMesh(OBJLoader::ParseOBJFile("meshes/tile_002.obj",&loaded_materials));
    assetmanager->AddNewAsset("tile_002",temp);
    temp->SetMesh(OBJLoader::ParseOBJFile("meshes/border_rock.obj",&loaded_materials));
    assetmanager->AddNewAsset("border_rock",temp);
    temp->SetMesh(OBJLoader::ParseOBJFile("meshes/editor_camera.obj",&loaded_materials));
    assetmanager->AddNewAsset("editor_camera",temp);
    temp->SetMesh(OBJLoader::ParseOBJFile("meshes/tile_gate.obj",&loaded_materials));
    ...
    loaded_materials.clear();
    arrows->SetMesh(OBJLoader::ParseOBJFile("meshes/arrows.obj",&loaded_materials));
    scene->renderer->AddMaterials(loaded_materials);
    ...
    testcube->SetMesh(OBJLoader::ParseOBJFile("meshes/test_cube.obj",&loaded_materials));
    ...
    tree->SetMesh(OBJLoader::ParseOBJFile("meshes/tree_001.obj",&loaded_materials));
    tree->name = "Tree 001";
    ...
    wall->SetMesh(OBJLoader::ParseOBJFile("meshes/wall_segment.obj",&loaded_materials));
    wall->name = "Wall 001";
    ...
    Texture* tex = scene->renderer->LoadTexture("textures/test_texture_4096.png");
    ...
    //skybox->LoadFromFile("textures/skybox/right.jpg",0);
    //skybox->LoadFromFile("textures/skybox/left.jpg",1);
    //skybox->LoadFromFile("textures/skybox/top.jpg",2);
    //skybox->LoadFromFile("textures/skybox/bottom.jpg",3);
    //skybox->LoadFromFile("textures/skybox/front.jpg",4);
    //skybox->LoadFromFile("textures/skybox/back.jpg",5);
    skybox->LoadFromFile("textures/skybox/px.jpg",0);
    skybox->LoadFromFile("textures/skybox/nx.jpg",1);
    skybox->LoadFromFile("textures/skybox/py.jpg",2);
    skybox->LoadFromFile("textures/skybox/ny.jpg",3);
    skybox->LoadFromFile("textures/skybox/pz.jpg",4);
    skybox->LoadFromFile("textures/skybox/nz.jpg",5);
...
Scene* ApplicationGrid::CreateBoneTestScene(){
    ...
    //Load from a GLTF file and build assets.
    gltfloader.LoadGLTFFile("meshes/trees.glb");
    ...
    //Load Elf Mesh
    gltfloader.LoadGLTFFile("meshes/elf.glb");
    {
        loaded_materials.clear();
    ...
    gltfloader.LoadGLTFFile("meshes/palmtree.glb");
    {
        loaded_materials.clear();
        gltfloader.ListNodes();
    ...
    selection_tile->SetMesh(OBJLoader::ParseOBJFile("meshes/selection_tile.obj",&loaded_materials));
    selection_tile->name = "Selection Tile";
